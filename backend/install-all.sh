...
services=("api-gateway" "auth-service" "user-service" "course-service" "content-service" "assessment-service" "report-service" "payment-service" "logs-service" "email-service")
